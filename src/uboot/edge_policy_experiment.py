...
def policy_snapshot(
    ...
    row: dict[str, Any] = {
        ...
        "responses_created_total": engine.counters["responses_created_total"],
        "responses_completed_total": engine.counters["responses_completed_total"],
        "responses_rejected_total": engine.counters["responses_rejected_total"],
        "current_queue_depth": len(engine.queue),
        "max_queue_depth": engine.counters["max_queue_depth"],
